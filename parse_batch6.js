...
const raw = fs.readFileSync('batch6_raw.txt', 'utf8');
const blocks = raw.split(/Pregunta \d+ de 6/i).filter(b => b.trim().length > 0);
...
fs.writeFileSync('parsed_batch6.json', JSON.stringify(parsed, null, 2));
